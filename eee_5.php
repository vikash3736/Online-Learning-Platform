...
<div class="container">
    ...
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-1">Power System-II</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-2">Control System</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-3">Electrical Machine-II</a>
      </div>
      <div class="six col">
