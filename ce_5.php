...
<div class="container">
    ...
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-1">PC-I- Steel Structure Design</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-2">PC - II - Geotechnical Engineering - I</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-3">PC- III - Environmental Engineering - III</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-4">PE - I</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-5">OE - I</a>
      </div>
