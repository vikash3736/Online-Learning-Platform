...
<div class="container">
    ...
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-1">Operating System</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-2">Design and Analysis Of Algorithms</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-3">Flat</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-4">Dicrete Mathrmatics</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-5">DBMS</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-6">Engineering Economics</a>
      </div>
