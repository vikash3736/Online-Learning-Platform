...
<div class="container">
    ...
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-1">Analog Electronics And Circuits</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-2">Analog  Communication</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-3">Signals And Systems</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-4">Microprocessor And Interfacing</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
