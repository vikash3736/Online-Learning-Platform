...
<div class="container">
    ...
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-1">Electrical Machine-I</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-2">Network Theory</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-3">Electromagnetic Field Theory</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-4">Basic Electronics</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
