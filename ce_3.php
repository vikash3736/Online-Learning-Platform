...
<div class="container">
    ...
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-1">CE Material & Construction</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-2">Surveying & Geomatics - I</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
      ...
      <div class="six col">
        <a href="#" class="button" id="button-4">Mathematics - I</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-5">Engineering Geology</a>
      </div>
      <div class="six col">
