...
<div class="container">
    ...
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-1">Microwave Engineering</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-2">VLSI</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-3">IoT</a>
      </div>
      <div class="six col">
    ...
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-5">Open Elective –II
