...
<div class="container">
    ...
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-1">Computer Architecture</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-2">Compiler Design</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-3">Computer Graphics</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-4">Computer Organization & Architecture</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-5">Computer Graphics</a>
      </div>
