<?php
  ...
  if (isset($_POST['mathematics_1'])) {
      $sub_name = "mathematics_1";
      if ($_SESSION['user']==="teacher") {
        echo "<script>window.open('teacher_sub.php','_self');</script>";
        $_SESSION['sub_name'] = $sub_name;
      }
  ...
  if (isset($_POST['basic_electrical'])) {
      $sub_name = "basic_electrical";
      if ($_SESSION['user']==="teacher") {
        echo "<script>window.open('teacher_sub.php','_self');</script>";
        $_SESSION['sub_name'] = $sub_name;
      }
...
<div class="container">
    ...
    <div class="row cf">
      <div class="six col">
        <form method="post">
          <input type="submit" name="physics_1" value="Physics - I" class="button" id="button-1">
        </form>
        <!-- <a href="#" class="button" id="button-1">Physics - I</a> -->
        
      </div>
      <div class="six col">
        <!-- <a href="#" class="button" id="button-2">Mathematics - I</a> -->
        <form method="post">
          <input type="submit" name="mathematics_1" value="Mathematics - I" class="button" id="button-1">
        </form>        
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <!-- <a href="#" class="button" id="button-3">Basic Electrical/ Engineering Chemistry - I</a> -->
        <form method="post">
          <input type="submit" name="basic_electrical" value="Basic Electrical" class="button" id="button-3">
        </form>
      </div>
