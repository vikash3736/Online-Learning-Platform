...
<div class="container">
    ...
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-1">Surveying & Geomatics</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-2">Fluid Mechanics & Fluid Machines</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-3">Structural Analysis - I</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-4">Concrete Structure Structure - I</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-5">Electronics & Instrumentation Engg</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-6">Environmental Economics</a>
      </div>
    </div>
