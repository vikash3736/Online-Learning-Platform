...
<div class="container">
    ...
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-1">Automation in Manufacturing</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-2">PEC-III</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-3">PEC-IV</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-4">OEC III</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-5">OEC IV</a>
      </div>
