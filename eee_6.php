...
<div class="container">
    ...
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-1">Power Electronics</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-2">Signals and Systems</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-3">Microprocessors and
Microcontroller</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-4">Professional Elective
Course -II</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-5">Open Elective Course -
II</a>
      </div>
