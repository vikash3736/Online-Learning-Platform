...
<div class="container">
    ...
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-1">Digital Signal Processing</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-2">Digital Communication</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-3">Microcontroller & Embedded system</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-4">Professional Elective –I</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-5">Professional Elective –I</a>
      </div>
