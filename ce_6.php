...
<div class="container">
    ...
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-1">PC - I - Concrete Structure - II</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-2">PC - II - Structure Analysis - II</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-3">Highway Engineering</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-4">Digital Electronics</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-5">PE - I </a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-6">0E -I </a>
      </div>
    </div>
