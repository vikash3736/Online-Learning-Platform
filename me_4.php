...
<div class="container">
    ...
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-1">Theory Of Machines</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-2">Fluid Machines</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-3">Applied Thermodynamics</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-4">Manufacturing Process-I</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
