...
<div class="container">
    ...
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-1">Data Structure & Algorithm</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-2">Object Oriented Programming</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-3">Basic Electronics</a>
      </div>
      <div class="six col">
    ...
    <div class="row cf">
      ...
      <div class="six col">
        <a href="#" class="button" id="button-6">Environmental Science</a>
      </div>
    </div>
