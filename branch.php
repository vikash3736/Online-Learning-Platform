...
<body>
<h1>ONLINE LEARNING PLATFORM <a href="logout.php" style="font-size: 12pt; border: 1px solid blue; padding: 10px; border-radius: 10px; background-color: blue; margin-left: 60px;">Logout</a></h1>
<h2>CHOOSE THE BRANCH :</h2>
<div class='container'>
  <!-- <button class='one'><b>CSE</b></button>
  <button class='two'><b>CIVIL</b></button>
  <button class='three'<b>ME</b></button>
  <button class='four'><b>EEE</b></button>
  <button class='five'> <b>ECE</b></button> -->
  <form method="post">
    <input type="submit" name="cse" class="one" value="CSE">
    <input type="submit" name="ce" class="two" value="CIVIL">
    <input type="submit" name="me" class="three" value="ME">
    <input type="submit" name="eee" class="four" value="EEE">
    <input type="submit" name="ece" class="five" value="ECE">
  </form>
</div>
