...
<div class="container">
    ...
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-1">Protection of Power Apparatus Sy</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-2">Professional Elective-III</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-3">Professional Elective-IV</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-4">Open Elective-III</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-5">Open Elective-IV</a>
      </div>
