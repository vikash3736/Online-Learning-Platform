...
<div class="container">
    ...
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-1">Computer Network</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-2">Data Science</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-3">Image Processing</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-4">System Software</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-5">Information Retrieval</a>
      </div>
