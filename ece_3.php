...
<div class="container">
    ...
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-1">Basic Electronics</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-2">Digital Electronics And Logic Design</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-3">Network Theory</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-4">Electromagnetic Field Theory</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
     ...
     <div class="six col">
        <a href="#" class="button" id="button-5">Environmental Science</a>
      </div>
    </div>
