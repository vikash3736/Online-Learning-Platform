...
<div class="container">
    ...
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-1">Artificial Inteligence</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-2">Machine Learning</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-3">Information Security</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-4">Cryptography</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-5">Values and Ethics in Profession</a>
      </div>
