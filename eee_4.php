...
<div class="container">
    ...
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-1">Power System – I</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-2">Measurement & Instrumentation</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-3">Analog Electronics And Circuits</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-4">Digital Electronics And Logic Design</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-5">Data Structure And Algorithm</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-6">Engineering Economics /Cyber Security</a>
      </div>
    </div>
