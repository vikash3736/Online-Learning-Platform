...
<div class="container">
    ...
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-1">Heat Transfer</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-2">Design of Machine Elements</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-3">Internal Combustion Engines</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-4">Design for Manufacturing</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-5">Principles of Management</a>
      </div>
