...
<div class="container">
    ...
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-1">Solid Mechanics</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-2">AutomobileEngineering</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-3">Design of Transmission System</a>
      </div>
      <div class="six col">
        <a href="#" class="button" id="button-4">Computer Aided Design</a>
      </div>
    </div>
    <div class="row cf">
      <div class="six col">
        <a href="#" class="button" id="button-5">Machine Tool Design</a>
      </div>
